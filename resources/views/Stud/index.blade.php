...
<div class="container">
    <div class="dropdown">
        <button class="btn btn-light btn-sm dropdown-toggle m-0" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="width: 100px; height: 30px;">
            Сорт. по
        </button>
        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            <a class="dropdown-item" href="{{ route('stud.index', ['sort' => 'name-asc']) }}">Имени <i class="fas fa-caret-down"></i></a>
            <a class="dropdown-item" href="{{ route('stud.index', ['sort' => 'name-desc']) }}">Имени <i class="fas fa-caret-up"></i></a>
            <a class="dropdown-item" href="{{ route('stud.index', ['sort' => 'lname-asc']) }}">Фамилии <i class="fas fa-caret-up"></i></a>
            <a class="dropdown-item" href="{{ route('stud.index', ['sort' => 'lname-desc']) }}">Фамилии <i class="fas fa-caret-down"></i></a>
        </div>
    </div>
<div class="row">
