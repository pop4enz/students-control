        ...
        <div class="row">
            <div class="col-lg-4 w-100 d-flex justify-content-start">
              -  <div class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-light active" style="color:black;">Удаление специальности</a>
            ...
            <div class="col-lg-4 w-100">
                <div class="row">
                        <form class="pt-2" id="studform" method="post" action="{{ route('admin.spec.del') }}">
                            <div class="form-group">
                                @csrf
                                @method('DELETE')
                                <label for="id">Выберите специальность:</label>
            ...
            <div class="col-lg-4 w-100 d-flex justify-content-start">
                <div class="list-group">
                    <a href="http://kurs.com/admin/spec" class="list-group-item list-group-item-light" style="color:black;">Добавление</a>
