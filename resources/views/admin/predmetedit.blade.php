        ...
        <div class="row">
            <div class="col-lg-4 w-100 d-flex justify-content-start">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-light active" style="color:black;">Изменение предмета</a>
                </div>
            </div>
            <div class="col-lg-4 w-100">
                <div class="row">
                        <form class="pt-2" id="studform" method="post" action="{{ route('admin.predmet.update') }}">
                            <div class="form-group">
                                ...
                                <label for="predname">Краткое название:</label>
                                <input type="text" class="form-control" name="predname"/>
                                <label for="fname">Полное название:</label>
            ...
            <div class="col-lg-4 w-100 d-flex justify-content-start ">
                <div class="list-group">
                    ...
                    <a href="http://kurs.com/admin/predmetdel" class="list-group-item list-group-item-light" style="color:black;">Удаление</a>
                </div>
            </div>
        </div>
        @if ($errors->any())
