        ...
        <div class="row">
            <div class="col-lg-4 w-100 d-flex justify-content-start">
                <div class="list-group">
                    <a href="http://kurs.com/admin/studdel" class="list-group-item list-group-item-light active" style="color:black;">Удаление студента</a>
                    ...
                    <a href="http://kurs.com/admin/predmetdel" class="list-group-item list-group-item-light" style="color:black;">Удаление предмета</a>
                </div>
            </div>
            <div class="col-lg-4 w-100">
                <div class="row">
                        <form class="pt-2" id="studform" method="post" action="{{ route('admin.stud.del') }}">
                            <div class="form-group">
                                ...
                                <select class="browser-default custom-select" name="id" form="studform">
                                    @foreach($studs as $stud)
                                        <option value="{{ $stud->id }}" title="{{ $stud->group->grname }}">{{ $stud->full_name }}</option>
                                    @endforeach
                                </select>
                            </div>
            ...
            <div class="col-lg-4 w-100 d-flex justify-content-start">
                <div class="list-group">
                    <a href="http://kurs.com/admin/stud" class="list-group-item list-group-item-light" style="color:black;">Добавление</a>
                    <a href="http://kurs.com/admin/studedit" class="list-group-item list-group-item-light" style="color:black;">Изменение</a>
