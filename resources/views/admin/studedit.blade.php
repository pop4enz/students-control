        ...
        <div class="row">
            <div class="col-lg-4 w-100 d-flex justify-content-start pt-5">
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-light active" style="color:black;">Изменение студента</a>
                    <a href="http://kurs.com/admin/groupedit" class="list-group-item list-group-item-light" style="color:black;">Изменение группы</a>
            ...
            <div class="col-lg-4 w-100">
                <div class="row">
                        <form class="pt-2" id="studform" method="post" action="{{ route('admin.stud.update') }}">
                            <div class="form-group">
                                ...
                                <label for="form_id">Форма обучения:</label>
                                <select class="browser-default custom-select" name="form_id" form="studform">
                                    @foreach ($forms as $form)
                                        <option value="{{ $form->id }}">{{ $form->nform }}</option>
                                    @endforeach
                                </select>
                            </div>
