        ...
        <div class="row">
            <div class="col-lg-4 w-100 d-flex justify-content-start pt-5">
                <div class="list-group">
                    <a href="#" class="list-group-item list-group-item-light active" style="color:black;">Добавление студента</a>
            ...
            <div class="col-lg-4 w-100">
                <div class="row">
                        <form class="pt-2" id="studform" method="post" action="{{ route('admin.stud.add') }}">
                            <div class="form-group">
                                ...
                                <select class="browser-default custom-select" name="group_id" form="studform">
                                    @foreach($groups as $group)
                                        <option value="{{ $group->id }}">{{ $group->grname }}</option>
                                    @endforeach
                                </select>
