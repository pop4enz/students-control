        ...
        <div class="row">
            <div class="col-lg-4 w-100 d-flex justify-content-start pt-5">
                <div class="list-group">
                    ...
                    <a href="http://kurs.com/admin/spec" class="list-group-item list-group-item-light" style="color:black;">Добавление специальности</a>
                    <a href="http://kurs.com/admin/predmet" class="list-group-item list-group-item-light" style="color:black;">Добавление предмета</a>
                    <a href="#" class="list-group-item list-group-item-light active" style="color:black;">Добавление оценки</a>
                </div>
            </div>
            <div class="col-lg-4 w-100">
                <div class="row">
                        <form class="pt-2" id="studform" method="post" action="{{ route('admin.ball.add') }}">
                            <div class="form-group">
                                @csrf
                                <label for="stud_id">Студент:</label>
                                <select class="browser-default custom-select" name="stud_id" form="studform">
                                    @foreach($studs as $stud)
                                        <option value="{{ $stud->id }}" title="{{ $stud->group->grname }}">{{ $stud->full_name }}</option>
                                    @endforeach
                                </select>
                                <label for="predmet_id">Предмет:</label>
                                <select class="browser-default custom-select" name="predmet_id" form="studform">
                                ...
                                <select class="browser-default custom-select" name="semester" form="studform">
                                ...
                                <label for="ball">Оценка:</label>
                                <select class="browser-default custom-select" name="ball" form="studform">
                                    <option value="1">1</option>
                                    <option value="2">2</option>
                                    <option value="3">3</option>
                                    <option value="4">4</option>
            ...
            <div class="col-lg-4 w-100 d-flex justify-content-start pt-5">
                <div class="list-group">
                    ...
                    <a href="http://kurs.com/admin/studdel" class="list-group-item list-group-item-light" style="color:black;">Удаление</a>
                </div>
            </div>
        </div>
        @if ($errors->any())
