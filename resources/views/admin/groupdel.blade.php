        ...
        <div class="row">
            <div class="col-lg-4 w-100 d-flex justify-content-start">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-light active" style="color:black;">Удаление группы</a>
            ...
            <div class="col-lg-4 w-100">
                <div class="row">
                        <form class="pt-2" id="studform" method="post" action="{{ route('admin.group.del') }}">
                            <div class="form-group">
                                @csrf
                                @method('DELETE')
                                <label for="f_name">Выберите</label>
            ...
            <div class="col-lg-4 w-100 d-flex justify-content-start">
                <div class="list-group">
                    ...
                    <a href="http://kurs.com/admin/groupedit" class="list-group-item list-group-item-light" style="color:black;">Изменение</a>
