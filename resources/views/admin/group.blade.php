        ...
        <div class="row">
            <div class="col-lg-4 w-100 d-flex justify-content-start">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-light active" style="color:black;">Добавление группы</a>
            ...
            <div class="col-lg-4 w-100">
                <div class="row">
                        <form class="pt-2" id="studform" method="post" action="{{ route('admin.group.add') }}">
                            <div class="form-group">
                                @csrf
                                <label for="grname">Номер группы:</label>
                                <input type="text" class="form-control" name="grname"/>
                                <label for="spec_id">Специальность:</label>
