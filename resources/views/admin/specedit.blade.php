...
<head>
    ...
    <title>Изменение специальности</title>
    <!-- Font Awesome -->
        ...
        <div class="row">
            <div class="col-lg-4 w-100 d-flex justify-content-start pt-5">
                <div class="list-group">
                    ...
                    <a href="#" class="list-group-item list-group-item-light active" style="color:black;">Изменение специальности</a>
            ...
            <div class="col-lg-4 w-100">
                <div class="row">
                        <form class="pt-2" id="studform" method="post" action="{{ route('admin.spec.update') }}">
                            <div class="form-group">
                                @csrf
                                @method('PATCH')
                                <label for="specname">Выберите специальность:</label>
                                <select class="browser-default custom-select" name="spec_id" form="studform">
                                    @foreach($specs as $spec)
                                        <option value="" title="{{ $spec->fak->fakdesc }}">---{{ $spec->fak->nfak }}---</option>
