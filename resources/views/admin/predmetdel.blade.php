...
<section class="sectstud pt-4">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 w-100 d-flex justify-content-start">
                <div class="list-group">
                    <a href="http://kurs.com/admin/studdel" class="list-group-item list-group-item-light" style="color:black;">Удаление студента</a>
                    <a href="http://kurs.com/admin/groupdel" class="list-group-item list-group-item-light" style="color:black;">Удаление группы</a>
                    <a href="http://kurs.com/admin/specdel" class="list-group-item list-group-item-light" style="color:black;">Удаление специальности</a>
                    <a href="#" class="list-group-item list-group-item-light active" style="color:black;">Удаление предмета</a>
                </div>
            </div>
            <div class="col-lg-4 w-100">
                <div class="row">
                        <form class="pt-2" id="studform" method="post" action="{{ route('admin.predmet.del') }}">
                            <div class="form-group">
                                @csrf
                                @method('DELETE')
                                <label for="f_name">Выберите студента:</label>
                                <label for="id">Имя и фамилия:</label>
                                <select class="browser-default custom-select" name="id" form="studform">
                                    @foreach($predmets as $predmet)
                                        <option value="{{ $predmet->id }}" title="{{ $predmet->fname }}">{{ $predmet->predname }}</option>
                                    @endforeach
                                </select>
                            </div>
            ...
            <div class="col-lg-4 w-100 d-flex justify-content-start">
                <div class="list-group">
                    <a href="http://kurs.com/admin/predmet" class="list-group-item list-group-item-light" style="color:black;">Добавление</a>
                    <a href="http://kurs.com/admin/predmetedit" class="list-group-item list-group-item-light" style="color:black;">Изменение</a>
                    <a href="#" class="list-group-item list-group-item-light active" style="color:black;">Удаление</a>
                </div>
            </div>
        </div>
        @if ($errors->any())
